                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <ul class="breadcrumb breadcrumb-style ">
                        <li class="breadcrumb-item">
                            <h4 class="page-title">Family Size Add</h4>
                        </li>
                        ...
                        <li class="breadcrumb-item active">Family Size Add</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="body">
                        <div class="header">
                            <h2 class="pt-2"><b>Family Size Add</b></h2>
                        ...
                        <div class="formCard">
                            <div class="wrapper">
                                {{ Form::open(['url' => route('admin.familysize.store'), 'method'=>'POST', 'files' => true, 'class' => 'user']) }}
