        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="body">
                        <div class="header">
                            <h2 class="pt-2"><b>Company Edit</b></h2>
                        ...
                        <div class="formCard">
                            <div class="wrapper">
                                {{ Form::open(['url' => route('admin.company.update',$company->id), 'method'=>'PUT','files' => true, 'class' => 'user']) }}
                                @include('backend.inc.company._form')
                                <div class="text-right">
                                    <input type="submit" class="btn btn-primary" name="edit_company" value="Update" />
                                </div>
                                {{ Form::close() }}
                            </div>
                        </div>
